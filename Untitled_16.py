...
if __name__ == "__main__":
    ...
    if os.path.exists(SKIP_FILE):
        ...
        if update_and_verify("Untitled_16.py"):
            print("🚀 本体を最新に更新しました。システムを再起動します...")
    print("\n--- 全ファイル最新です。起動します ---")
#^^^^^^From Gemini
#______From Seed
...
def home_print(txt=""):
    print(txt)
    print(f"""
元素パズル簡易版　:ver.1.1.76.24(Dev-1.1.0d76-140)
...
""")
        ...
        if step=="home.start":
            break
        if step=="web.bug":
            webbrowser.open("https://docs.google.com/forms/d/e/1FAIpQLSd1-lfWq73XTnFF7Hf5c4F2H3BaCYrt4M_Lcm7lsLMRtamXGQ/viewform?usp=publish-editor")
            step="home.quit"
        if step=="home.quit":
            sys.exit()
